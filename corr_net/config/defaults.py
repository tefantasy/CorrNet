...
# Model architecture.
_C.MODEL.ARCH = "corr_net"

# Model name
_C.MODEL.MODEL_NAME = "CorrNet"
...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["c2d", "i3d", "slow", "x3d", "corr_net"]
...
# -----------------------------------------------------------------------------
# Correlation Net options
# -----------------------------------------------------------------------------
_C.CORR_NET = CfgNode()

_C.CORR_NET.TYPE = "corr_26"
...
# if True, each video should be represented as a tar file containing jpeg sequence of each frame.
_C.DATA.USE_FRAME_SEQUENCES = False

_C.DATA.FRAME_SEQUENCE_TEMPLATE = "img_{:05d}.jpg"
